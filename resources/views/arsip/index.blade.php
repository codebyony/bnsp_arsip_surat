	...
	<section class="content">
        ...
        <div class="box-footer">
          ...
          <div class="input-group col-md-offset-8">
            <input class="form-control" placeholder="Cari Surat..." value="{{ Request::get('search') }}" name="search">
        ...
        <div class="row">
          ...
          @endif
                  ...
                  <div class="box-body table-responsive">
                    <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>{{ $i->nomor_surat }}</td>
                          <td>{{ $i->kategori->nama_kategori }}
                          </td>
                          <td>{{ Str::limit($i->judul, 50) }}</td>
                          <td>{{ $i->waktu_pengarsipan }}</td>
                          <td>
                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modal-delete" data-nomor_surat={{ $i->nomor_surat }} id="btn-delete">
                              Hapus
                            </button>
                            <a href="/download/{{ $i->nomor_surat }}" class="btn btn-sm btn-warning">Unduh</a>
                            <a class="btn btn-sm btn-primary" href="/{{ $i->nomor_surat }}">Lihat >></a>
                          </td>
                        </tr>
                        @endforeach
                      </tbody>
			...
			<div class="box-footer">
        <div class="col-md-2">
          <a href="/create" class="btn btn-block btn-primary btn-sm"><i class="fa fa-plus"></i> &nbsp; Arsipkan Surat</a></div>
			</div>
			<!-- /.box-footer-->
		</div>
	</section>
